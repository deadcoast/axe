...
PANEL_STYLES = {
    ...
    "error": {"border_style": BORDERS["error"], "padding": SPACING["padding_medium"]},
    "info": {"border_style": BORDERS["info"], "padding": SPACING["padding_medium"]},
}
...
STATUS_STYLES = {
    "loading": {"spinner_style": COLORS["primary"], "text_style": TEXT_STYLES["body"]},
    "success": {
        "spinner_style": COLORS["accent"],
        "text_style": TEXT_STYLES["success"],
    },
    ...
    "error": {"spinner_style": COLORS["error"], "text_style": TEXT_STYLES["error"]},
}
