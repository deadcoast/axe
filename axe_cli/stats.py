...
class StatsManager:
    ...
    def save_persistent_stats(self):
        ...
        try:
            ...
            console.print(f"[bold red]Warning:[/bold red] Could not save statistics: {e}")
    ...
    def reset_persistent_stats(self):
        ...
        try:
            ...
            console.print(f"[bold red]Error:[/bold red] Could not reset statistics: {e}")
    
    def show_run_stats(self):
        """Display statistics for current run"""
        total = self.run_stats['success'] + self.run_stats['failed'] + self.run_stats['skipped']
    ...
    def show_persistent_stats(self):
        ...
        total = (self.persistent_stats['total_success'] + 
        ...
        if self.persistent_stats['first_run']:
            try:
                first_run_dt = datetime.fromisoformat(self.persistent_stats['first_run'])
