...
class ThemeManager:
    ...
    def _load_custom_themes(self) -> Dict[str, Dict[str, Any]]:
        ...
        for theme_file in self.themes_dir.glob("*.json"):
            try:
                ...
                console.print(
                    f"[bold red]Warning:[/bold red] Could not load custom theme {theme_file}: {e}"
                )
    ...
    def create_custom_theme(
        ...
        if not base_data:
            console.print(
                f"[bold red]Error:[/bold red] Base theme '{base_theme}' not found"
            )
            return False
        ...
        try:
            ...
            console.print(
                f"[bold green]✓[/bold green] Custom theme '{name}' created successfully"
            )
            return True

        except IOError as e:
            console.print(
                f"[bold red]Error:[/bold red] Could not save custom theme: {e}"
            )
            return False
    ...
    def delete_custom_theme(self, name: str) -> bool:
        ...
        if name not in self.custom_themes:
            console.print(
                f"[bold red]Error:[/bold red] Custom theme '{name}' not found"
            )
            return False
        ...
        try:
            ...
            console.print(
                f"[bold green]✓[/bold green] Custom theme '{name}' deleted successfully"
            )
            return True

        except IOError as e:
            console.print(
                f"[bold red]Error:[/bold red] Could not delete custom theme: {e}"
            )
            return False
