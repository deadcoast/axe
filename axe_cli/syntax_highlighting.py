...
class SyntaxHighlighter:
    ...
    def highlight_code(self, content: str, language: str = 'text', 
                     theme: str = 'default', line_numbers: bool = True) -> Syntax:
    ...
    def highlight_file(self, file_path: Path, theme: str = 'default', 
                      line_numbers: bool = True) -> Optional[Syntax]:
    ...
    def display_code_block(self, content: str, language: str = 'text', 
                          title: str = "", theme: str = 'default'):
    ...
    def display_file(self, file_path: Path, theme: str = 'default', 
...
class MarkdownRenderer:
    ...
    def _process_code_blocks(self, content: str, theme: str) -> str:
        ...
        def replace_code_block(match):
            ...
            syntax = self.syntax_highlighter.highlight_code(code_content, language, theme)
    ...
    def display_markdown_file(self, file_path: Path, theme: str = 'default'):
        ...
        try:
            ...
            console.print(f"[bold red]Error reading markdown file {file_path}:[/bold red] {e}")
